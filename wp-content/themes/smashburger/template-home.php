...
get_header(); ?>
	<div id="primary" class="content-area">
		...
		<section style="background-image: url(<?php echo $backgroundImage ;?>);" id="eight" class="clear flex hide-for-small" data-speed="7" data-offsetY="875" data-type="background">
